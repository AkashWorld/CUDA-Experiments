...
int main(int argc, char **argv) {
  ...
  cublas_matrix_multiplication(1024, 500);
  cublas_matrix_multiplication(1024, 1000);
  cublas_matrix_multiplication(1024, 2000);
  cublas_matrix_multiplication(2048, 500);
  cublas_matrix_multiplication(2048, 1000);
  cublas_matrix_multiplication(2048, 2000);
  cublas_matrix_multiplication(4096, 500);
  cublas_matrix_multiplication(4096, 1000);
  cublas_matrix_multiplication(4096, 2000);
  cuda_matrix_multiplication(1024, 500);
  cuda_matrix_multiplication(1024, 1000);
  cuda_matrix_multiplication(1024, 2000);
  cuda_matrix_multiplication(2048, 500);
  cuda_matrix_multiplication(2048, 1000);
  cuda_matrix_multiplication(2048, 2000);
  cuda_matrix_multiplication(4096, 500);
  cuda_matrix_multiplication(4096, 1000);
  cuda_matrix_multiplication(4096, 2000);
  cuda_block_matrix_multiplication(1024, 500);
  cuda_block_matrix_multiplication(1024, 1000);
  cuda_block_matrix_multiplication(1024, 2000);
  cuda_block_matrix_multiplication(2048, 500);
  cuda_block_matrix_multiplication(2048, 1000);
  cuda_block_matrix_multiplication(2048, 2000);
  cuda_block_matrix_multiplication(4096, 500);
  cuda_block_matrix_multiplication(4096, 1000);
  cuda_block_matrix_multiplication(4096, 2000);
